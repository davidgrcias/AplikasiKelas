        ...
        <!-- Simple Datatable start -->
				<div class="card-box mb-30" id = "tableka">
					<div class="pd-20" style = "display: flex; align-items: center; justify-content: space-between; padding-right: 20px; box-sizing: border-box;">
						<h4 class="text-blue h4">Data Table Publisher</h4>
						<a href="addpublisher.php" class = "btn btn-success">Add Publisher</a>
					</div>
					<div class="pb-20">
                  ...
                  <th>Publisher Name</th>
							...
							<tbody>
                <?php
    							$userfull = query("SELECT * FROM publisher ORDER BY id DESC");
									$i = 1;
    						?>
    						<?php foreach($userfull as $user) : ?>
								<tr id = "<?php echo $user['id']; ?>">
									...
									<td id = "namaberita"><?php echo $user["kodepenerbit"]; ?></td>
                  <td> <?php echo $user["namapenerbit"]; ?> </td>
									<td id = "<?php echo $user['id']; ?>">
										<div class="dropdown" id = "<?php echo $user['id']; ?>">
    										...
    										<a class="dropdown-item" href="editpublisher.php?id=<?php echo $user['id']; ?>"><i class="dw dw-edit2"></i> Edit</a>
                      ...
                      <script type="text/javascript">
          							function deleteaccountadmin(iduser){
          									$(document).ready(function(){
          											var deleteid = iduser;
          											var kode = "hapuspublisher";
          											<?php if($admin["notif"] == "y") : ?>
          											var confirmalert = confirm("Are You Sure You Want To Delete This Publisher?");
          											<?php else : ?>
