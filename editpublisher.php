...
<body>
  ...
  $zilong = $_GET["id"];
  $yujao = mysqli_query($connt, "SELECT * FROM publisher WHERE id = $zilong");
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="publisher.php">Publisher</a></li>
				...
				<div class="pd-20 card-box mb-30" style = "padding-bottom: 5px!important;">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Edit Publisher</h4>
						</div>
					</div>
          <div class="row" style = "display: flex; flex-direction: column; align-items: center; text-align: center!important; padding-bottom: 40px;">
              ...
              <input type="hidden" name="oldcode" id = "oldcode" value="<?php echo $z['kodepenerbit']; ?>">
							<label class="col-sm-12 col-md-2 col-form-label">Publisher Code</label>
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "publishercode" name = "publishercode" maxlength="49" spellcheck="false" value = "<?php echo $z['kodepenerbit']; ?>">
							</div>
						</div>
            <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Publisher Name</label>
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "publishername" name = "publishername" maxlength="59" spellcheck="false" value = "<?php echo $z['namapenerbit']; ?>">
							</div>
						</div>
            <div class="form-group row">
        ...
        <script type="text/javascript">
          function jadi(){
              $(document).ready(function(){
                  ...
                  var publishercode = document.getElementById('publishercode').value;
                  var publishername = document.getElementById('publishername').value;
                  var id = "<?php echo $_GET['id']; ?>";
                  var kode = "editpublisher";
                    $.ajax({
                      url: 'function.php',
                      type: 'POST',
                      data: {id:id,oldcode:oldcode,publishercode:publishercode,publishername:publishername,kode:kode},
                      success: function(response){
                      if(response == 1){
                        alert('Publisher Changed Successfully!');
