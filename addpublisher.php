		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30" style = "padding-bottom: 5px!important;">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Add Publisher</h4>
						</div>
					</div>
          <div class="row" style = "display: flex; flex-direction: column; align-items: center; text-align: center!important; padding-bottom: 40px;">
            ...
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "publishercode" name = "publishercode" maxlength="49" spellcheck="false">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Publisher Name</label>
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "publishername" name = "publishername" maxlength="59" spellcheck="false">
							</div>
						</div>
            <div class="form-group row">
        ...
        <script type="text/javascript">
          function jadi(){
              $(document).ready(function(){
                  ...
                  var kode = "addpublisher";
                    $.ajax({
                      url: 'function.php',
                      type: 'POST',
                      data: {publishername:publishername,publishercode:publishercode,kode:kode},
