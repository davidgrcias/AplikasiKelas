	...
	<div class="main-container">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="title">
								<h4>Text Display Setting</h4>
							</div>
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="../perpustakaan/">Dashboard</a></li>
									<li class="breadcrumb-item active" aria-current="page">Text Display</li>
								</ol>
							</nav>
						</div>
					</div>
        ...
        ?>
				...
				<div class="pd-20 card-box mb-30" style = "padding-bottom: 5px!important;">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Text Display Setting</h4>
						</div>
					</div>
          <div class="row" style = "display: flex; flex-direction: column; align-items: center; text-align: center!important; padding-bottom: 40px;">
					...
					<form id = "myForm" method = "post" action = "" autocomplete = "off">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Website Title</label>
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "title" name = "title" maxlength="49" value = "<?php echo $utama['nama']; ?>" spellcheck="false">
							</div>
						</div>
            <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Copyright</label>
							<div class="col-sm-12 col-md-10">
								<input type="text" required maxlength="129" class="form-control" id="copyright" name = "copyright" value = "<?php echo $utama['copyright']; ?>" spellcheck="false">
							</div>
						</div>
            <div class="form-group row">
              ...
              $(document).ready(function(){
                  ...
                  var kode = "ubahutama";
                    $.ajax({
                      url: 'function.php',
                      type: 'POST',
                      data: {title:title, copyright:copyright,kode:kode},
