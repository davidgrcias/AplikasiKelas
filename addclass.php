		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30" style = "padding-bottom: 5px!important;">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Add Class</h4>
						</div>
					</div>
					...
					<form id = "myForm" method = "post" action = "" autocomplete = "off">
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input required type="text" class="form-control" id = "class" name = "class" maxlength="30" spellcheck="false">
							</div>
						</div>
            <div class="form-group row">
