		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Add Lending</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30" style = "padding-bottom: 5px!important;">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue">Add Lending</h4>
						</div>
					</div>
          <div class="row" style = "display: flex; flex-direction: column; align-items: center; text-align: center!important; padding-bottom: 40px;">
            ...
            <div class="form-group row">
                  ...
                  <?php foreach($xol as $xo) : ?>
									<option value="<?php echo $xo['nisn']; ?>"><?php echo $xo["nama"]; ?> and <?php echo $xo['nisn']; ?></option>
                  <?php endforeach; ?>
								</select>
							</div>
						</div>
            ...
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<select name = "idbuku" id = "idbuku" class="custom-select col-12" required>
									<option value = "" selected hidden>Choose...</option>
                  <?php foreach($pol as $po) : ?>
									<option value="<?php echo $po['id']; ?>"><?php echo $po["judul"]; ?> by <?php echo $po["pengarang"]; ?></option>
                  <?php endforeach; ?>
								</select>
							</div>
						</div>
            <div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input required type="date" class="form-control" id = "borrowdate" name = "borrowdate" maxlength="29" spellcheck="false">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Return Date</label>
							<div class="col-sm-12 col-md-10">
								<input required type="date" class="form-control" id = "returndate" name = "returndate" maxlength="29" spellcheck="false">
							</div>
						</div>
            <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Total</label>
							<div class="col-sm-12 col-md-10">
								<input required type="number" class="form-control" id = "total" name = "total" maxlength="9" spellcheck="false">
							</div>
						</div>
            <div class="form-group row">
              ...
              $(document).ready(function(){
                  ...
                  var kode = "addlending";
                    $.ajax({
                      url: 'function.php',
                      type: 'POST',
                      data: {nisn:nisn,idbuku:idbuku,total:total,borrowdate:borrowdate,returndate:returndate,kode:kode,uniqid:uniqid},
